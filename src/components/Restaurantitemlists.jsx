    ...
    return (
        <article className="container mx-auto flex-col">
              <div className="w-50 h-40 relative ">
                ...
                <span className="bg-orange-500 text-white text-xs px-2 py-1 rounded flex flex-row"><img src="./icons/discount.png" alt="" />{props.discount}</span>
                <span className="bg-yellow-400 text-white text-xs px-2 py-1 rounded flex flex-row"><img src="./icons/time.png" alt="" />Fast</span>
              </div>
              </div>
